...
async function createEvent(booking) {
  ...
  const event = {
    ...
    description:
      `Boot: ${booking.boat_length_m}m × ${booking.boat_width_m}m\n` +
      ...
      (booking.boat_latitude ? `\nCoördinaten: ${booking.boat_latitude}, ${booking.boat_longitude}` : ''),
    location: booking.boat_latitude
      ? `${booking.boat_latitude},${booking.boat_longitude}`
